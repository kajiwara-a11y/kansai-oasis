...
const _OASIS_RULES = [
  // ── Store-level / "今日の安いもの" type questions ─────────────
  { pat: /(オアシス|OASIS|阪急|店).*(安|お得|特売|セール|何が|なにが|なに|何)/i, r: '神戸三宮店 本日のお買い得トップ5: ① 鶏もも肉 ¥398 (−33%) ② 春キャベツ 1玉 ¥98 (−38%) ③ 北海道銀鮭 2切 ¥498 (−28%) ④ 兵庫朝採卵 10個 ¥178 (−28%) ⑤ 木綿豆腐 300g ¥88 (−31%)。組合せて 親子丼 / 鮭の塩焼き / 肉じゃがが作れます。' },
  { pat: /(今日|本日).*(安|お得|特売|セール|おすすめ|オススメ)/i, r: '本日特に強いのは: 鶏もも肉 ¥398、春キャベツ ¥98、銀鮭 ¥498。¥1,000 以下で 3 種類揃うので、親子丼 + 千切りキャベツ + 鮭のホイル焼きの献立がぴったりです。' },
  { pat: /(おすすめ|オススメ|何が良い|なにがいい|何かいいの)/i, r: '今夜のおすすめ: 鶏もも肉と卵が特売中なので「ふんわり親子丼」が一番お得。15分・4人前 ¥1,180。さらに春キャベツ ¥98 で「コールスロー」を添えれば豪華に。' },
  { pat: /(献立|こんだて|メニュー|何作る|なに作る|何作ろう|なに作ろう)/i, r: '今夜のおすすめ3献立: ① 親子丼 ¥1,180 / 15分 ② 肉じゃが ¥1,400 / 30分 ③ 鮭の塩焼き定食 ¥1,200 / 10分。どれも特売食材を使い、30分以内で作れます。' },
  { pat: /(今夜|今晩|夜ごはん|晩御飯|晩ごはん|夕ごはん|夕飯|夕食)/i, r: '今夜は親子丼が一押し(15分・¥1,180)。「もう少しヘルシー」なら銀鮭の塩焼き定食(10分・¥1,200)、「節約」なら豚バラ豚汁(¥1,000 以下)もどうぞ。' },
  { pat: /(朝|朝食|朝ごはん|朝飯|モーニング)/i, r: '朝食には 食パン6枚 ¥248 + 兵庫朝採卵 ¥178 + 北海道牛乳 ¥198。トータル ¥624 で家族4人分まかなえます。' },
  { pat: /(昼|昼食|お昼|ランチ|ひるごはん)/i, r: 'お昼は 三色丼弁当 ¥540 か 寿司12貫 ¥980 がお手軽。お弁当作りなら 鶏もも肉 ¥398 で「鶏照り焼き弁当」が定番です。' },
  // ── 具体的食材 → レシピ提案 ──────────────────────────────────
  ...
  // ── キャンペーン・季節・イベント ────────────────────────────
  { pat: /(北海道|フェア|催事|イベント)/i, r: '11/26 まで北海道フェア開催中。銀鮭・牛乳・じゃがいも・とうきびチョコなど 80 品目が最大 30% OFF。鮮魚 F-2 と日配 C-1 が中心です。' },
  { pat: /(タイムセール|17時|17:00|夕方|夕ご飯|夕食)/i, r: '本日 17:00 から お惣菜・お弁当・寿司・揚げ物が 最大 20% OFF。デリコーナー(D-1)とお弁当コーナー(D-2)へどうぞ。' },
  { pat: /(誕生日|お祝い|記念日|パーティー)/i, r: 'お祝いには 握り寿司12貫 ¥980 + 唐揚げ大盛 ¥780 + ロールケーキ ¥598 = ¥2,358 で家族 4 人のパーティーセット完成。お刺身盛り合わせ ¥698 も追加すると豪華です。' },
  { pat: /(お正月|年末|年始|おせち)/i, r: '12/15 からおせち予約受付開始予定。今のところは年末特売(12/28〜31)で 鯛 / 数の子 / 黒豆 / 紅白なますの材料セット ¥4,800 をご用意します。' },
  // ── 飲料・お酒・おやつ ──────────────────────────────────────
  { pat: /(お酒|ビール|ワイン|日本酒|酎ハイ|サワー|ハイボール)/i, r: '酒類・飲料コーナー(B-2)に: サッポロ黒ラベル 6缶 ¥980、灘の銘酒 720ml ¥1,580、神戸ワイン ¥1,280 などお買い得。本日はおつまみ枝豆 ¥198 もセット推奨。' },
  { pat: /(おやつ|スイーツ|デザート|お菓子|チョコ|プリン|アイス)/i, r: 'ベーカリーの メロンパン(17:00 焼上り) + 北海道牛乳 ¥198 がお子様向けに人気。スイーツコーナーには季節限定 栗のロールケーキ ¥598、抹茶プリン ¥248 も。' },
  // ── 食事スタイル ──────────────────────────────────────────
  { pat: /(健康|栄養|バランス|オーガニック)/i, r: 'バランス重視なら 銀鮭塩焼き + 三色野菜サラダ + 味噌汁 のセット。1人 580kcal、タンパク質 32g。¥1,420 で 4人前です。' },
  { pat: /(ベジ|菜食|ヴィーガン|肉なし|肉抜き|ベジタリアン)/i, r: 'お野菜中心: 豆腐ハンバーグ(¥780)・彩り野菜サラダ(¥600)・味噌汁(¥80)。タンパク質は豆腐と納豆 ¥98 で十分まかなえます。' },
  { pat: /(辛|スパイス|カレー)/i, r: 'カレー一式 ¥1,200 (4人前)。豚バラ ¥498 + 玉ねぎ ¥198 + ルー ¥248 で 30 分で本格カレー。ライス炊飯時間込みです。' },
  { pat: /(鍋|なべ|おでん|寒|あったか)/i, r: '寒い夜は おでん!  大根 ¥158、こんにゃく ¥98、卵 ¥178、はんぺん ¥138 で家族 4 人 ¥1,200。出汁付きの便利パック ¥598 も鮮魚横にあります。' },
  // ── サービス・店舗情報 ──────────────────────────────────────
  { pat: /(在庫|残ってる|まだある|売り切れ)/i, r: '本日 17:00 時点: 鶏もも肉 残り 24パック、兵庫朝採卵 残り 18パック、銀鮭 残り 8パック、春キャベツ 残り 15玉。お早めに!' },
  { pat: /(駐車|車|駐車場|パーキング)/i, r: '神戸三宮店の駐車場は地下 B1F に 80 台分。EV 充電器 4 基、自転車駐輪場あり。2 時間まで無料、以降 200円/30分です。' },
  { pat: /(2F|二階|上階|ライフスタイル|衣料|化粧品)/i, r: '2F LIFESTYLE フロア: ファッション・子供服・化粧品・キッチン雑貨・日用品・文具・カフェ。階段か EV で上がれます。' },
  { pat: /(キッチンエール|宅配|配達|デリバリー|宅配便)/i, r: '阪急キッチンエール: 本日 14:00 までのご注文で当日 18:00 までお届け可能。配送料 ¥330(¥3,000 以上で無料)。' },
  { pat: /(LINE|line|公式|友達追加|ライン)/i, r: '公式 LINE 友だち追加でクーポン即時配信中。お得情報を見逃さないように。マイページ → 設定 → 連携 からどうぞ。' },
  { pat: /(litta|リッタ|電子マネー)/i, r: 'litta(リッタ)電子マネーは S ポイント連動。毎週水・土・日のお支払いで実質 4 倍ポイント貯まります。' },
];
